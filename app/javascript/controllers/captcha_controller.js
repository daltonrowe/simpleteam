...
export default class extends Controller {
  ...
  render() {
    this.widgetId = turnstile.render(this.element, { ...this.captchaArgs, execution: 'execute' });
  ...
  submit(event) {
    ...
    if (event.submitter) {
      ...
      turnstile.execute(this.element, { ...this.captchaArgs, callback: this.success, 'error-callback': this.error, 'expired-callback': this.expired })
    }
  }
